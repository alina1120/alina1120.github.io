...
var Key = new function () {
    ...
    var codeBase = "onekey",
		...
		imgsUrl = "" //图片目录
    previewImgs = [
    "http://img4.91huo.cn/zs/2014/03/17/api/appalpha.png",
    "http://img4.91huo.cn/zs/2014/03/17/api/bg_pop.png",
	"http://img4.91huo.cn/zs/2014/03/17/api/ie6bg_pop.gif",
	"http://img4.91huo.cn/zs/2014/03/17/api/pic1new.gif",
	"http://img4.91huo.cn/zs/2014/03/17/api/pic2new.gif",
    "http://img4.91huo.cn/zs/2014/03/17/api/script.gif"]; //图片名称 （预加载)
	...
	style += '.onekey_con{ display:none; background:url(http://img4.91huo.cn/zs/2014/03/17/api/bg_pop.png) no-repeat; padding:15px; width:570px; height:397px; z-index:99999; position: fixed; _position: absolute; top: 24%; left: 50%; margin-left: -285px; _top:expression(documentElement.scrollTop+0.76*documentElement.clientHeight-this.offsetHeight)}';
	style += '.poptitle{ height:37px; padding:0 0 0 12px; position:relative; zoom:1;}';
	style += '.poptitle .logo{ display:block; float:left; width:24px; height:37px; background:url(http://img4.91huo.cn/zs/2014/03/17/api/script.gif) no-repeat 0 0; margin:0 6px 0 0;}';
	...
	style += '.poptitle .close_btn{ display:block; width:13px; height:13px; position:absolute; top:13px; right:14px; background:url(http://img4.91huo.cn/zs/2014/03/17/api/script.gif) no-repeat -25px 0; overflow:hidden;}';
	...
	style += '.pop_con1 .appcon span.r_border65{ display:block; width:65px; height:65px; position:absolute; top:0; left:0; background:url(http://img4.91huo.cn/zs/2014/03/17/api/appalpha.png) no-repeat;}';
	...
	style += '.pop_con2 .rightpic{ display:block; width:176px; height:166px; background:url(http://img4.91huo.cn/zs/2014/03/17/api/pic1new.gif) no-repeat; position:absolute; top:7px; right:27px;}';
	style += '.pop_con3{ padding:19px 42px 0 0;}';
	style += '.pop_con3 a{ display:block; width:110px; height:39px; float:right; margin:0 0 0 16px; line-height:39px; text-align:center; font-size:16px; background:url(http://img4.91huo.cn/zs/2014/03/17/api/script.gif) no-repeat;}';
    ...
    function GetWin(obj, platform, downloadurl, url) {
        ...
        win1 += '<div class="popcon" id="onekey_win_null">';
			...
			win2 += '<img src="http://img4.91huo.cn/zs/2014/03/17/api/pic2new.gif" />';
    ...
    this.callBack = function (data) {
		...
		var downUrl = "http://dl.sj.91.com/business/assistant/91assistant_3.0242.exe";
        //try {
